...
from solargs.api.utils.file_utils import get_project_base_directory
...
class RagTokenizer:
    ...
    def tokenize(self, line):
        ...
        res = " ".join(res)#" ".join(self.english_normalize_(res))
    ...
    def fine_grained_tokenize(self, tks):
        ...
        return " ".join(res)#" ".join(self.english_normalize_(res))
