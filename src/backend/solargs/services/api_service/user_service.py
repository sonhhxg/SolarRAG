...
from solargs.api.apps.db.db_models import DB, UserTenant
from solargs.api.apps.db.db_models import User, Tenant
from solargs.services.api_service.base_service import BaseService
from solargs.api.utils import get_uuid, get_format_time, current_timestamp, datetime_format
from solargs.api.apps.db import StatusEnum,UserTenantRole
...
class UserService(BaseService):
    ...
    def query_user(cls, email, password):
        """Login user account password matching"""
